...
var SlackMessage = (function () {
  ...
  _createClass(SlackMessage, [{
    ...
    value: function sendTestReport(nrFailedTests) {
      this.sendMessage(this.getTestReportMessage(), nrFailedTests > 0 && this.loggingLevel !== _constLoggingLevels2['default'].SUMMARY ? {
        "attachments": [{
          color: 'danger',
    ...
    value: function getTestReportMessage() {
      ...
      if (errorMessage.length > 0 && this.loggingLevel !== _constLoggingLevels2['default'].SUMMARY) {
