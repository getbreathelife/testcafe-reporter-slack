...
exports['default'] = function () {
  return {
    ...
    reportTaskStart: function reportTaskStart(startTime, userAgents, testCount) {
      ...
      if (loggingLevel !== _constLoggingLevels2['default'].MINIMAL) {
    ...
    reportTestDone: function reportTestDone(name, testRunInfo) {
      ...
      if (loggingLevel === _constLoggingLevels2['default'].TEST || hasErr && loggingLevel === _constLoggingLevels2['default'].MINIMAL) {
    ...
    reportTaskDone: function reportTaskDone(endTime, passed, warnings, result) {
      ...
      if (loggingLevel === _constLoggingLevels2['default'].MINIMAL && !result.failedCount) {
        return;
      }
      this.slack.addMessage(message);
