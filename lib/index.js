...
exports['default'] = function () {
  return {
    ...
    reportTaskStart: function reportTaskStart(startTime, userAgents, testCount) {
      ...
      if (loggingLevel !== _constLoggingLevels2['default'].FAILURE) {
    ...
    reportTestDone: function reportTestDone(name, testRunInfo, meta) {
      ...
      if (meta.url) {
        this.slack.addMessage(_utilsEmojis2['default'].rightArrow + ' Test URL: ' + meta.url);
      }
      ...
      if (loggingLevel === _constLoggingLevels2['default'].TEST || hasErr && loggingLevel === _constLoggingLevels2['default'].FAILURE) {
    ...
    reportTaskDone: function reportTaskDone(endTime, passed, warnings, result) {
      ...
      if (loggingLevel === _constLoggingLevels2['default'].FAILURE && !result.failedCount) {
        return;
      }
      this.slack.addMessage(message);
